...
function PassiveMenuMessage_Entry_Content(sObjProperNoun, sImageName, vOriginalW, vOriginalH, d1ZoomModeSets, d1ZoomCardinalSets, vLowerLeveru, d2MessageMatrix){
   
   bPassiveMenu_Menu_visible = true; // false; //
   
   if( navigator.appName==sInternetExplorer ){
      
      // window.status = sInternetExplorer;
      
      Explorer_PassiveMenuMessage_Entry_Content(sObjProperNoun, sImageName, vOriginalW, vOriginalH, d1ZoomModeSets, d1ZoomCardinalSets, vLowerLeveru, d2MessageMatrix);
      ...
      Netscape_PassiveMenuMessage_Entry_Content(sObjProperNoun, sImageName, vOriginalW, vOriginalH, d1ZoomModeSets, d1ZoomCardinalSets, vLowerLeveru, d2MessageMatrix);
      ...
      Gecko_PassiveMenuMessage_Entry_Content(sObjProperNoun, sImageName, vOriginalW, vOriginalH, d1ZoomModeSets, d1ZoomCardinalSets, vLowerLeveru, d2MessageMatrix);
      
   }
   
}

function Gecko_PassiveMenuMessage_Entry_Content(sObjProperNoun, sImageName, vOriginalW, vOriginalH, d1ZoomModeSets, d1ZoomCardinalSets, vLowerLeveru, d2MessageMatrix){
   ...
   PassiveMenu_Define_Menu(d1ZoomModeSets,d1ZoomScaleSets,d1ZoomModeToValue);
   ...
   // alert(
   // "vPassiveMenu_MenuHeight="+vPassiveMenu_MenuHeight+"; "+"\n"+
   // "(PassiveMenu_Menu).style.height="+document.getElementById("PassiveMenu_Menu_Inner").style.height+"; "+"\n"+
   // "(PassiveMenu_Menu_Inner).offsetHeight="+document.getElementById("PassiveMenu_Menu_Inner").offsetHeight+"; "+"\n"+
   // "");
...
function Explorer_PassiveMenuMessage_Entry_Content(sObjProperNoun, sImageName, vOriginalW, vOriginalH, d1ZoomModeSets, d1ZoomCardinalSets, vLowerLeveru, d2MessageMatrix){
...
function Netscape_PassiveMenuMessage_Entry_Content(sObjProperNoun, sImageName, vOriginalW, vOriginalH, d1ZoomModeSets, d1ZoomCardinalSets, vLowerLeveru, d2MessageMatrix){
...
function PassiveMenu_Define_Menu(d1ZoomModeSets,d1ZoomScaleSets,d1ZoomModeToValue){
...
function lExist_JavaScript_pasmen00( ){
