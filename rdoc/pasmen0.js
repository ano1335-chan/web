...
// var nTimer_MenuClose = 2;
// var nTimer_MenuSlide = 3;
// var nTimer_MenuSlideOpen = 2;
// var nTimer_MenuSlideClose = 3;

var lPassiveMenu_MenuOpen = false; // true; //
...
d1fIdlingHandler[d1fIdlingHandler.length] = PassiveMenu_ScrolledMenuClose;
...
function PassiveMenu_MenuOpen(oSensor){
   
   if( navigator.appName==sInternetExplorer ){
      // Explorer
      
      Explorer_PassiveMenu_MenuOpen(oSensor);
      
   }
   else if( (navigator.appName==sNetscapeNavigator) && (vVerCompatible<5) ){
      // Netscape
      
      Netscape_PassiveMenu_MenuOpen(oSensor);
      ...
      Gecko_PassiveMenu_MenuOpen(oSensor);
      
   }
   
}

function Gecko_PassiveMenu_MenuOpen(oSensor){
   
   var sSensorObjName = oSensor.id;
   ...
   vMenuX = Math.floor(vViewOffsetX + vFrameWidth / 2 - (document.getElementById("PassiveMenu_Menu").offsetWidth / 2) );
   vMenuY = Math.floor(Math.max(vViewOffsetY,vPassiveMenu_MenuMinY) );
   
   vMouse_LastCursorX = -1;
   vMouse_LastCursorY = -1;
   
   document.getElementById("PassiveMenu_Menu").style.left = vMenuX;
   document.getElementById("PassiveMenu_Menu").style.top = vMenuY;
   document.getElementById("PassiveMenu_Menu").style.visibility = "visible";
...
function Explorer_PassiveMenu_MenuOpen(oSensor){
...
function Netscape_PassiveMenu_MenuOpen(oSensor){
...
function Gecko_PassiveMenu_MenuOpenHandler(event){
   // EventSource
   ...
   vPassiveMenu_MenuHeight = Math.max(vPassiveMenu_MenuHeight,document.getElementById("PassiveMenu_Menu_Inner").offsetHeight);
   var vMenuWidth = document.getElementById("PassiveMenu_Menu").offsetWidth;
   ...
   if( vMouse_Sensitivity<=Math.max(Math.abs(vVMouseX),Math.abs(vVMouseY)) ){
      ...
      if(lApproach){
         ...
         if(vPassiveMenu_SlideStep<=0){
            ...
            vPassiveMenu_SlideStep = 1;
            vPassiveMenu_SlideQuantity = nPassiveMenu_Slide_OpenQuantity;
            Gecko_PassiveMenu_MenuSlideHandler(event);
            // SetTimer(nTimer_MenuClose,nPassiveMenu_Wait);
         ...
         lPassiveMenu_MouseOver = false; // true; //
         // Gecko_PassiveMenu_MenuCloseHandler(oSource);
         SetTimer(nTimer_MenuClose,nPassiveMenu_Wait);
   ...
   if( vMouse_Sensitivity<=Math.max(Math.abs(vVMouseX),Math.abs(vVMouseY)) ){
      ...
      if(lApproach){
         ...
         if(vPassiveMenu_SlideStep<=0){
            ...
            vPassiveMenu_SlideStep = 1;
            vPassiveMenu_SlideQuantity = nPassiveMenu_Slide_OpenQuantity;
            Explorer_PassiveMenu_MenuSlideHandler(oSource);
            // SetTimer(nTimer_MenuClose,nPassiveMenu_Wait);
   ...
   if( vMouse_Sensitivity<=Math.max(Math.abs(vVMouseX),Math.abs(vVMouseY)) ){
      ...
      if(lApproach){
         ...
         if(vPassiveMenu_SlideStep<=0){
            ...
            vPassiveMenu_SlideStep = 1;
            vPassiveMenu_SlideQuantity = nPassiveMenu_Slide_OpenQuantity;
            Netscape_PassiveMenu_MenuSlideHandler(oEvent);
            // SetTimer(nTimer_MenuClose,nPassiveMenu_Wait);
...
function PassiveMenu_MenuSlideHandler(event){
   ...
   if( navigator.appName==sInternetExplorer ){
      ...
      lResult = Explorer_PassiveMenu_MenuSlideHandler(event);
      ...
      lResult = Netscape_PassiveMenu_MenuSlideHandler(event);
      ...
      lResult = Gecko_PassiveMenu_MenuSlideHandler(event);
...
function Gecko_PassiveMenu_MenuSlideHandler(event){
   ...
   if(vPassiveMenu_SlideStep!=0){
      ...
      document.getElementById("PassiveMenu_Menu").style.top = vOpenY;
      
      document.getElementById("PassiveMenu_Menu").style.clip = "rect("
       +vOpenYDeduct+"," // Top
       +document.getElementById("PassiveMenu_Menu").offsetWidth+"," // Right
...
function Explorer_PassiveMenu_MenuSlideHandler(oSource){
...
function Netscape_PassiveMenu_MenuSlideHandler(oEvent){
...
function Gecko_PassiveMenu_MenuClose(){
   // EventSource
   ...
   document.getElementById("PassiveMenu_Menu").style.visibility = "hidden";
...
function PassiveMenu_MenuCloseHandler(oEventSource){
   ...
   if( navigator.appName==sInternetExplorer ){
      ...
      lResult = Explorer_PassiveMenu_MenuCloseHandler(oEventSource);
   }
   
   else if( (navigator.appName==sNetscapeNavigator) && (vVerCompatible<5) ){
      // Netscape
      
      lResult = Netscape_PassiveMenu_MenuCloseHandler(oEventSource);
      ...
      lResult = Gecko_PassiveMenu_MenuCloseHandler(oEventSource);
...
function Gecko_PassiveMenu_MenuCloseHandler(event){
   // EventSource
   ...
   if(vPassiveMenu_SlideStep == 1){
      ...
      Gecko_PassiveMenu_MenuSlideHandler();
...
function Gecko_PassiveMenu_CloseCancelHandler(event){
   // EventSource
   ...
   // window.status = "Gecko_PassiveMenu_CloseCancelHandler";
...
function PassiveMenu_ScrolledMenuClose( ){
   ...
   if( navigator.appName==sInternetExplorer ){
      ...
      Gecko_PassiveMenu_ScrolledMenuClose( );
...
function Gecko_PassiveMenu_ScrolledMenuClose( ){
   ...
   if(
    ...
    (vView_LastOffsetY != vViewOffsetY) )
      ...
      if( typeof document.getElementById("PassiveMenu_Menu") == "object"){
      	 
         if(document.getElementById("PassiveMenu_Menu").style.visibility == "visible"){
...
function Explorer_PassiveMenu_ScrolledMenuClose(){
   ...
   if(
    ...
    (vView_LastOffsetY != vViewOffsetY) )
      ...
      if( typeof document.all.PassiveMenu_Menu == "object"){
...
function Netscape_PassiveMenu_ScrolledMenuClose(){
   ...
   if(
    ...
    (vView_LastOffsetY != vViewOffsetY) )
      ...
      if( typeof document.PassiveMenu_Menu == "object"){
...
function Initialize_pasmen0( ){
   
   var i,q;
   var sSensorObjName, oSensor, oContainer;
   var vPMMX,vPMMY;
   
   i = d1PassiveMessage_SensorObjNameList.length-1;
   ...
   if( lPassiveMenu_MenuOpen ){
      PassiveMenu_MenuOpen(oSensor);
   }
   
   lPassiveMenu_MenuOpen = false; // true; //
   
}

// ###############################################################

function lExist_JavaScript_pasmen0( ){
