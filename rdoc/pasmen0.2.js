...
function PassiveMenu_MenuSlideHandler( ){
   ...
   if( (navigator.appName==sNetscapeNavigator) && (vVerCompatible<5) ){
      ...
      lResult = Netscape_PassiveMenu_MenuSlideHandler( );
      ...
      lResult = Explorer_PassiveMenu_MenuSlideHandler( );
...
var lJavaScript_LoadCheck_pasmen0 = true; // false; //
